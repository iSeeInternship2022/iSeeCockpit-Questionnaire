...
import { Button, Card, Layout, Input, Space, message } from 'antd';
...
import type { ChatBot, Interaction } from '@/models/questionnaire';
...
/* const json = {
  questions: [
    {
      content: 'This is a checkbox question (e.g. modes of transport used)',
    ...
    {
      content: 'This is a numeric question',
      dimension: 'Curiosity',
      required: false,
      responseType: 'Number',
      validators: {
    ...
    {
      content: 'This is a radio question',
    ...
    {
      content: 'This is a free text question',
      dimension: 'Goodness',
      required: false,
...
const DialogQuestionnaires: React.FC = () => {
  ...
  const [question, setQuestion] = useState<ChatBot>();
